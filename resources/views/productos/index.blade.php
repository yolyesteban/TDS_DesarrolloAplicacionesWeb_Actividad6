            ...
            <table class="table table-striped table-sm table-hover">
                ...
                @foreach($productos as $producto)
                    <tr>
                        ...
                        <td>
                            <div class="mt-1">
                                <a href="/productos/{{$producto->codigoProducto}}/editar" class="btn btn-sm btn-outline-warning">Editar</a>
                                <a href="/productos/{{$producto->codigoProducto}}/eliminar" class="btn btn-sm btn-outline-danger">Eliminar</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
